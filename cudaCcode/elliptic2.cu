...
//            if((ie==11)&&(je==11))
//            {
//                printf("ie=%d, je=%d, Aglobal=%f, ii=%d,jj=%d, Amat=%f, FNmat=%f, Bmat=%f",ie, je, Aglobal[ie][je],ii,jj,Amat[ii][jj],FNmat[ii][jj],Bmat[ii][jj]); 
//            }
...
//printf("Aglobal[11][11]=%f",Aglobal[11][11]);
/*
